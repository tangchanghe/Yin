...
try {
    ...
    if (rules.length > 1 && getParam("rule") == "风影") {
        putVar("fy手动fy", "1");
        require(readFile("hiker://files/rules/FYJK/git.txt") || "https://ghproxy.net/https://raw.githubusercontent.com/tangchanghe/Yin/refs/heads/main/ycl.js");
        gx();
    };
    let list;
    ...
    for (let i in tit) {
        ...
        d.push({
            ...
            url: $("#noLoading#").lazyRule((li, add, up, lis, lio, los) => {
                function Snackbar() {
                    const hikerPop = $.require((readFile("hiker://files/rules/FYJK/git.txt") || "https://ghproxy.net/https://raw.githubusercontent.com/tangchanghe/Yin/refs/heads/main/ycl.js").replace(/[^/]*$/, "hikerPop.js"));
