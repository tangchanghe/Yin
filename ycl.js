...
try {
    ...
    http = (readFile("hiker://files/rules/FYJK/git.txt") || "https://ghproxy.net/https://raw.githubusercontent.com/tangchanghe/Yin/refs/heads/main/ycl.js").replace(/[^/]*$/, "");
};
...
function gx() {
    ...
    if (更新up || 手 || 强 || 手d) {
        ...
        if (bbh == "报错") {
            let codeberg = "https://ghproxy.net/https://raw.githubusercontent.com/tangchanghe/Yin/refs/heads/main/";
            let framagit = "https://ghproxy.net/https://raw.githubusercontent.com/tangchanghe/Yin/refs/heads/main/";
